...
const String kAppName = 'ShikiDev';
...
void main(List<String> args) async {
  ...
  // await renameOutputApks(
  //   outputDir,
  //   from: 'app-release.apk',
  //   to: '$kAppName-v$appVersionName($appVersionCode)-arm64-v8a-release.apk',
  // );

  await Future.wait([
    ...variants.map((arch) => renameOutputApks(outputDir,
        from: 'app-$arch-prod-release.apk',
        to: '$kAppName-$appVersionName-$arch-alpha.apk'))
  ]);
}
